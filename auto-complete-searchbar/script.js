...
autoCompleteInputTag.addEventListener("keyup", (event) => {
    autoCompleteInputTag.classList.add("focus");
    if (
        event.key === "ArrowDown" ||
        event.key === "ArrowUp" ||
        event.key === "Enter"
...
const navigateAndSelectProduct = (key) => {
    if (key === "ArrowDown") {
        ...
        const selectedProductName = document.getElementsByClassName("selected")[0].firstChild.innerHTML;
        const headerToShowSelectedProduct = document.createElement("h4");
        headerToShowSelectedProduct.classList.add("selectedProduct");
        headerToShowSelectedProduct.append("You selected: ", selectedProductName);
        document.getElementsByTagName("body")[0].append(headerToShowSelectedProduct);
    }
}
...
const deselectProduct = () => {
    const productItemContainerToDeselect = document.getElementsByClassName("selected")[0];
    productItemContainerToDeselect.style.backgroundColor = "white";
    productItemContainerToDeselect.firstChild.style.color = "black";
